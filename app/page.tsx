...
export default function Home() {
  const { grid, generation, controls, history, cell } = useGameOfLife();
  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen gap-8 p-4">
      ...
      <div className="flex gap-4 mt-4">
        <Button
          className=" border-gray-300 bg-white text-black hover:bg-gray-100 transition-colors shadow-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed"
